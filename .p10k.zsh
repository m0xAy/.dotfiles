# Generated by Powerlevel10k configuration wizard on 2023-03-19 at 10:21 NZDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=0 # WAS 254
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=0 # WAS 250
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=0 # WAS 255
...
POWERLEVEL9K_TERM_SHELL_INTERGRATION=true
